...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-10 p-4 bg-white shadow rounded-3">
            <h1 class="fw-bold fs-3 mb-4 text-primary">Crear nuevo blog</h1>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <img src="/img/blog/seo_image.jpg" class="img-fluid mb-2 rounded">
                        {!! Form::file('seo_image', ['class' => 'form-control']) !!}
                    </div>
                    <div class="mb-3">
                        {!! Form::label('image', 'Imagen principal (900x300px)') !!}<br>
                        <img src="/img/blog/image.jpg" class="img-fluid mb-2 rounded">
            ...
            <div class="text-end">
                {!! Form::submit('Crear blog', ['class' => 'btn btn-primary px-4']) !!}
            </div>
