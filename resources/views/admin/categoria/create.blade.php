...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-10 p-4 bg-white shadow rounded-3">
            <h1 class="fw-bold fs-3 mb-4 text-primary">Crear nueva categoría</h1>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <img src="/img/categoria/seo_image.jpg" class="img-fluid mb-2 rounded">
                        {!! Form::file('seo_image', ['class' => 'form-control']) !!}
                    </div>

                    <div class="mb-3">
                        {!! Form::label('image', 'Imagen principal (900x300px)') !!}<br>
                        <img src="/img/categoria/image.jpg" class="img-fluid mb-2 rounded">
            ...
            <div class="text-end">
                {!! Form::submit('Crear categoría', ['class' => 'btn btn-primary px-4']) !!}
            </div>
