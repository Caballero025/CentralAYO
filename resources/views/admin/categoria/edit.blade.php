...
<div class='container'>
    <div class="row">
        ...
        <div class="col-sm-10 p-5 bg-light">
            <h1 class="fw-bold fs-3 text-warning">EDITAR CATEGORÍA</h1>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="form-group mb-3">
                        ...
                        <img src="/img/categoria/{{ $categoria->seo_image }}" class="img-fluid mb-2 rounded">
                        {!! Form::file('seo_image', ['class' => 'form-control']) !!}
                    </div>

                    <div class="form-group mb-3">
                        {!! Form::label('image', 'Imagen principal (900x300px)') !!}<br>
                        <img src="/img/categoria/{{ $categoria->image }}" class="img-fluid mb-2 rounded">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="form-check form-switch mb-3">
                        {!! Form::checkbox('portada', 1, $categoria->portada, ['class' => 'form-check-input', 'id' => 'portada']) !!}
                        {!! Form::label('portada', 'Mostrar en portada', ['class' => 'form-check-label']) !!}
                    </div>
                    <div class="form-check form-switch">
                        {!! Form::checkbox('publicado', 1, $categoria->publicado, ['class' => 'form-check-input', 'id' => 'publicado']) !!}
            ...
            <div class="text-end">
                {{ Form::submit('Actualizar categoría', ['class' => 'btn btn-warning px-4 text-white']) }}
            </div>
