...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-10 p-5 bg-light">
            <h1 class="fw-bold fs-3 text-primary">EDITAR PRODUCTO</h1>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-4">
                            ...
                            {!! Form::number('precio_anterior', $producto->precio_anterior, ['class' => 'form-control', 'required']) !!}
                        </div>
                        <div class="col-sm-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="form-group mb-3">
                        ...
                        <img src="/img/producto/{{ $producto->seo_image }}" class="img-fluid mb-2 rounded">
                        {!! Form::file('seo_image', ['class' => 'form-control']) !!}
                    </div>

                    <div class="form-group mb-3">
                        {!! Form::label('image', 'Imagen principal (900x300px)') !!}<br>
                        <img src="/img/producto/{{ $producto->image }}" class="img-fluid mb-2 rounded">
            ...
            <div class="card mb-4">
                <div class="card-header bg-primary text-white fw-semibold">Opciones</div>
                <div class="card-body">
                    <div class="form-check form-switch mb-3">
                        {!! Form::checkbox('publicado', 1, $producto->portada, ['class' => 'form-check-input', 'id' => 'publicado']) !!}
            ...
            <div class="text-end">
                {{ Form::submit('Actualizar producto', ['class' => 'btn btn-primary px-4 text-white']) }}
            </div>
